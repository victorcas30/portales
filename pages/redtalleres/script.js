...
function realizarBusqueda() {
    ...
    const tallerSelect = document.getElementById("tallerSelect").value;
    //console.log("Taller: " + tallerSelect)
    ...
    const url = `https://redmedicaservice.devacsa.com/api/Directorios/obtenerdirectoriotaller?tipoDirectorio=${tallerSelect}&IdCiudad=${ubicacionesSelect}${nombreBusquedaParametro}&elementosporpagina=1000&paginaactual=1`;
